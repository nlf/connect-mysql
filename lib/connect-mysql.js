 ...
 */
function encryptData(plaintext, secret, algorithm, hashing, encodeas, iv) {
 ...
 */
function decryptData(ciphertext, secret, algorithm, hashing, encodeas, iv) {
  if (ciphertext)
